...
# 复制 JAR 文件到容器的工作目录
# 根据您的目录结构，JAR 文件位于 system-bootstrap/target/system-bootstrap-1.0.0-SNAPSHOT.jar
COPY xianzhi-system/system-bootstrap/target/system-bootstrap-1.0.0-SNAPSHOT.jar app.jar
