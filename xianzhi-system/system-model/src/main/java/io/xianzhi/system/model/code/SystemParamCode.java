...
@Getter
@AllArgsConstructor
public enum SystemParamCode implements Result {
    /**
     * 系统参数名称已经存在
     */
    PARAM_NAME_EXISTS(CommonCode.DATA_EXISTS.code(), "sys.param.name.exists"),
    /**
     * 系统参数编码已经存在
     */
    PARAM_CODE_EXISTS(CommonCode.DATA_EXISTS.code(), "sys.param.code.exists"),
