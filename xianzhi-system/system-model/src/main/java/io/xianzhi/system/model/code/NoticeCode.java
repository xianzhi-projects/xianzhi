...
@Getter
@AllArgsConstructor
public enum NoticeCode implements Result {
    /**
     * 公告名称已经存在
     */
    NOTICE_NAME_EXISTS(CommonCode.DATA_EXISTS.code(), "sys.notice.name.exists"),
    /**
     * 公告编码已经存在
     */
    NOTICE_CODE_EXISTS(CommonCode.DATA_EXISTS.code(), "sys.notice.code.exists"),
    /**
     * 公告不存在
     */
    NOTICE_NOT_EXISTS(CommonCode.DATA_NOT_EXISTS.code(), "sys.notice.not.exists"),
    ;
