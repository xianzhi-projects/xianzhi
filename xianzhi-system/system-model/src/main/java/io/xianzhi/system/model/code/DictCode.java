...
@Getter
@AllArgsConstructor
public enum DictCode implements Result {

    /**
     * 字典名称已经存在
     */
    DICT_NAME_EXISTS(CommonCode.DATA_EXISTS.code(), "sys.dict.name.exists"),
    /**
     * 字典编码已经存在
     */
    DICT_CODE_EXISTS(CommonCode.DATA_EXISTS.code(), "sys.dict.code.exists"),
    /**
     * 字典不存在
     */
    DICT_NOT_EXISTS(CommonCode.DATA_NOT_EXISTS.code(), "sys.dict.not.exists"),
