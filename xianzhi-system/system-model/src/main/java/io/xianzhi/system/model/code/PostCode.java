...
@Getter
@AllArgsConstructor
public enum PostCode implements Result {
    /**
     * 岗位名称已经存在
     */
    POST_NAME_EXISTS(CommonCode.DATA_EXISTS.code(), "sys.post.name.exists"),
    /**
     * 岗位编码已经存在
     */
    POST_CODE_EXISTS(CommonCode.DATA_EXISTS.code(), "sys.post.code.exists"),
    /**
     * 岗位不存在
     */
    POST_NOT_EXISTS(CommonCode.DATA_NOT_EXISTS.code(), "sys.post.not.exists"),
    ;
