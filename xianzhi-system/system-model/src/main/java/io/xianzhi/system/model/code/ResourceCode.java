...
public enum ResourceCode implements Result {
     ...
     * 资源名称已经存在
     */
    RESOURCE_NAME_EXISTS(CommonCode.DATA_EXISTS.code(), "sys.resource.name.exists"),
    /**
     * 资源编码已经存在
     */
    RESOURCE_KEY_EXISTS(CommonCode.DATA_EXISTS.code(), "sys.resource.key.exists"),
    /**
     * 资源不存在
     */
    RESOURCE_NOT_EXISTS(CommonCode.DATA_NOT_EXISTS.code(), "sys.resource.not.exists"),
    ;
